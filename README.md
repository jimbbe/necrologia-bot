...
**Error de mount en Caddyfile:** el compose actual ya no monta `Caddyfile`. Si aparece ese error, Hostinger está usando un stack viejo: borrarlo y crearlo de cero.
